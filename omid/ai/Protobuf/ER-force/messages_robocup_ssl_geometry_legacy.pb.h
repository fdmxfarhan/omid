...
class SSL_GeometryFieldSize final :
 ...
 public:
  ...
  int32_t free_kick_from_defense_dist() const;
  ...
  int32_t penalty_spot_from_field_line_dist() const;
  ...
  int32_t penalty_line_from_spot_dist() const;
...
class SSL_GeometryData final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::RoboCup2014Legacy::Geometry::SSL_GeometryFieldSize* release_field();
