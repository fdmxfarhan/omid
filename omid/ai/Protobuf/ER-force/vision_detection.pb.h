...
class Vision_DetectionBall final :
 ...
 public:
  ...
  Vision_DetectionBall* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  uint32_t ball_state() const;
  void set_ball_state(uint32_t value);
  private:
  uint32_t _internal_ball_state() const;
  void _internal_set_ball_state(uint32_t value);
  public:
  ...
  uint32_t last_touch() const;
  void set_last_touch(uint32_t value);
  private:
  uint32_t _internal_last_touch() const;
  void _internal_set_last_touch(uint32_t value);
  public:
 ...
 private:
  ...
  float y_;
  float height_;
  uint32_t ball_state_;
  uint32_t last_touch_;
  bool valid_;
  float raw_x_;
  float raw_y_;
...
class Vision_DetectionRobot final :
 ...
 public:
  ...
  Vision_DetectionRobot* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class Vision_DetectionFrame final :
 ...
 public:
  ...
  Vision_DetectionFrame* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::Vision_DetectionBall* release_balls();
...
inline uint32_t Vision_DetectionBall::_internal_area() const {
  return area_;
}
inline uint32_t Vision_DetectionBall::area() const {
  // @@protoc_insertion_point(field_get:Vision_DetectionBall.area)
  return _internal_area();
}
inline void Vision_DetectionBall::_internal_set_area(uint32_t value) {
  _has_bits_[0] |= 0x00000004u;
  area_ = value;
}
inline void Vision_DetectionBall::set_area(uint32_t value) {
...
inline uint32_t Vision_DetectionBall::_internal_ball_state() const {
  return ball_state_;
}
inline uint32_t Vision_DetectionBall::ball_state() const {
  // @@protoc_insertion_point(field_get:Vision_DetectionBall.ball_state)
  return _internal_ball_state();
}
inline void Vision_DetectionBall::_internal_set_ball_state(uint32_t value) {
  _has_bits_[0] |= 0x00000040u;
  ball_state_ = value;
}
inline void Vision_DetectionBall::set_ball_state(uint32_t value) {
...
inline uint32_t Vision_DetectionBall::_internal_last_touch() const {
  return last_touch_;
}
inline uint32_t Vision_DetectionBall::last_touch() const {
  // @@protoc_insertion_point(field_get:Vision_DetectionBall.last_touch)
  return _internal_last_touch();
}
inline void Vision_DetectionBall::_internal_set_last_touch(uint32_t value) {
  _has_bits_[0] |= 0x00000080u;
  last_touch_ = value;
}
inline void Vision_DetectionBall::set_last_touch(uint32_t value) {
...
inline uint32_t Vision_DetectionRobot::_internal_robot_id() const {
  return robot_id_;
}
inline uint32_t Vision_DetectionRobot::robot_id() const {
  // @@protoc_insertion_point(field_get:Vision_DetectionRobot.robot_id)
  return _internal_robot_id();
}
inline void Vision_DetectionRobot::_internal_set_robot_id(uint32_t value) {
  _has_bits_[0] |= 0x00000002u;
  robot_id_ = value;
}
inline void Vision_DetectionRobot::set_robot_id(uint32_t value) {
