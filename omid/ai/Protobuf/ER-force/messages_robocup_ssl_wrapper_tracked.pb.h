...
inline std::string* TrackerWrapperPacket::release_uuid() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = uuid_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
...
inline std::string* TrackerWrapperPacket::release_source_name() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = source_name_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (source_name_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
