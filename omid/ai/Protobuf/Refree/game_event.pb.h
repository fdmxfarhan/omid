...
class SSL_Referee_Game_Event_Originator final :
 ...
 public:
  ...
  SSL_Referee_Game_Event_Originator* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  public:
  void clear_botid();
  uint32_t botid() const;
  void set_botid(uint32_t value);
  private:
  uint32_t _internal_botid() const;
  void _internal_set_botid(uint32_t value);
  public:
...
class SSL_Referee_Game_Event final :
 ...
 public:
  ...
  SSL_Referee_Game_Event* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::SSL_Referee_Game_Event_Originator* release_originator();
...
inline uint32_t SSL_Referee_Game_Event_Originator::_internal_botid() const {
  return botid_;
}
inline uint32_t SSL_Referee_Game_Event_Originator::botid() const {
  // @@protoc_insertion_point(field_get:SSL_Referee_Game_Event.Originator.botId)
  return _internal_botid();
}
inline void SSL_Referee_Game_Event_Originator::_internal_set_botid(uint32_t value) {
  _has_bits_[0] |= 0x00000002u;
  botid_ = value;
}
inline void SSL_Referee_Game_Event_Originator::set_botid(uint32_t value) {
