...
class SaveState_CardInfo final :
 ...
 public:
  ...
  SaveState_CardInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class SaveState_TimeoutInfo final :
 ...
 public:
  ...
  SaveState_TimeoutInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  uint32_t left_before() const;
  void set_left_before(uint32_t value);
  private:
  uint32_t _internal_left_before() const;
  void _internal_set_left_before(uint32_t value);
  public:
...
class SaveState final :
 ...
 public:
  ...
  SaveState* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::SSL_Referee* release_referee();
  ...
  PROTOBUF_NODISCARD ::SaveState_CardInfo* release_last_card();
  ...
  PROTOBUF_NODISCARD ::SaveState_TimeoutInfo* release_timeout();
  ...
  PROTOBUF_NODISCARD ::SaveState_TimeoutInfo* release_last_timeout();
  ...
  uint32_t yellow_penalty_goals() const;
  void set_yellow_penalty_goals(uint32_t value);
  private:
  uint32_t _internal_yellow_penalty_goals() const;
  void _internal_set_yellow_penalty_goals(uint32_t value);
  public:
  ...
  uint32_t blue_penalty_goals() const;
  void set_blue_penalty_goals(uint32_t value);
  private:
  uint32_t _internal_blue_penalty_goals() const;
  void _internal_set_blue_penalty_goals(uint32_t value);
  public:
  ...
  void set_time_taken(uint64_t value);
  private:
  uint64_t _internal_time_taken() const;
  void _internal_set_time_taken(uint64_t value);
  public:
 ...
 private:
  ...
  uint32_t yellow_penalty_goals_;
  uint32_t blue_penalty_goals_;
...
inline uint32_t SaveState_TimeoutInfo::_internal_left_before() const {
  return left_before_;
}
inline uint32_t SaveState_TimeoutInfo::left_before() const {
  // @@protoc_insertion_point(field_get:SaveState.TimeoutInfo.left_before)
  return _internal_left_before();
}
inline void SaveState_TimeoutInfo::_internal_set_left_before(uint32_t value) {
  _has_bits_[0] |= 0x00000002u;
  left_before_ = value;
}
inline void SaveState_TimeoutInfo::set_left_before(uint32_t value) {
...
inline uint32_t SaveState::_internal_yellow_penalty_goals() const {
  return yellow_penalty_goals_;
}
inline uint32_t SaveState::yellow_penalty_goals() const {
  // @@protoc_insertion_point(field_get:SaveState.yellow_penalty_goals)
  return _internal_yellow_penalty_goals();
}
inline void SaveState::_internal_set_yellow_penalty_goals(uint32_t value) {
  _has_bits_[0] |= 0x00000010u;
  yellow_penalty_goals_ = value;
}
inline void SaveState::set_yellow_penalty_goals(uint32_t value) {
...
inline uint32_t SaveState::_internal_blue_penalty_goals() const {
  return blue_penalty_goals_;
}
inline uint32_t SaveState::blue_penalty_goals() const {
  // @@protoc_insertion_point(field_get:SaveState.blue_penalty_goals)
  return _internal_blue_penalty_goals();
}
inline void SaveState::_internal_set_blue_penalty_goals(uint32_t value) {
  _has_bits_[0] |= 0x00000020u;
  blue_penalty_goals_ = value;
}
inline void SaveState::set_blue_penalty_goals(uint32_t value) {
...
inline uint64_t SaveState::_internal_time_taken() const {
  return time_taken_;
}
inline uint64_t SaveState::time_taken() const {
  // @@protoc_insertion_point(field_get:SaveState.time_taken)
  return _internal_time_taken();
}
inline void SaveState::_internal_set_time_taken(uint64_t value) {
  _has_bits_[0] |= 0x00000040u;
  time_taken_ = value;
}
inline void SaveState::set_time_taken(uint64_t value) {
