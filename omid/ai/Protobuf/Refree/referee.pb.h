...
class SSL_Referee_TeamInfo final :
 ...
 public:
  ...
  SSL_Referee_TeamInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void set_goalie(uint32_t value);
  private:
  uint32_t _internal_goalie() const;
  void _internal_set_goalie(uint32_t value);
  public:
...
class SSL_Referee_Point final :
 ...
 public:
  ...
  SSL_Referee_Point* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class SSL_Referee final :
 ...
 public:
  ...
  SSL_Referee* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::SSL_Referee_TeamInfo* release_yellow();
  ...
  PROTOBUF_NODISCARD ::SSL_Referee_TeamInfo* release_blue();
  ...
  PROTOBUF_NODISCARD ::SSL_Referee_Point* release_designated_position();
  ...
  PROTOBUF_NODISCARD ::SSL_Referee_Game_Event* release_gameevent();
...
inline uint32_t SSL_Referee_TeamInfo::_internal_score() const {
  return score_;
}
inline uint32_t SSL_Referee_TeamInfo::score() const {
  // @@protoc_insertion_point(field_get:SSL_Referee.TeamInfo.score)
  return _internal_score();
}
inline void SSL_Referee_TeamInfo::_internal_set_score(uint32_t value) {
  _has_bits_[0] |= 0x00000002u;
  score_ = value;
}
inline void SSL_Referee_TeamInfo::set_score(uint32_t value) {
...
inline uint32_t SSL_Referee_TeamInfo::_internal_red_cards() const {
  return red_cards_;
}
inline uint32_t SSL_Referee_TeamInfo::red_cards() const {
  // @@protoc_insertion_point(field_get:SSL_Referee.TeamInfo.red_cards)
  return _internal_red_cards();
}
inline void SSL_Referee_TeamInfo::_internal_set_red_cards(uint32_t value) {
  _has_bits_[0] |= 0x00000004u;
  red_cards_ = value;
}
inline void SSL_Referee_TeamInfo::set_red_cards(uint32_t value) {
...
inline uint32_t SSL_Referee_TeamInfo::_internal_yellow_card_times(int index) const {
  return yellow_card_times_.Get(index);
}
inline uint32_t SSL_Referee_TeamInfo::yellow_card_times(int index) const {
  // @@protoc_insertion_point(field_get:SSL_Referee.TeamInfo.yellow_card_times)
  return _internal_yellow_card_times(index);
}
inline void SSL_Referee_TeamInfo::set_yellow_card_times(int index, uint32_t value) {
  yellow_card_times_.Set(index, value);
  // @@protoc_insertion_point(field_set:SSL_Referee.TeamInfo.yellow_card_times)
}
inline void SSL_Referee_TeamInfo::_internal_add_yellow_card_times(uint32_t value) {
  yellow_card_times_.Add(value);
}
inline void SSL_Referee_TeamInfo::add_yellow_card_times(uint32_t value) {
...
inline uint32_t SSL_Referee_TeamInfo::_internal_yellow_cards() const {
  return yellow_cards_;
}
inline uint32_t SSL_Referee_TeamInfo::yellow_cards() const {
  // @@protoc_insertion_point(field_get:SSL_Referee.TeamInfo.yellow_cards)
  return _internal_yellow_cards();
}
inline void SSL_Referee_TeamInfo::_internal_set_yellow_cards(uint32_t value) {
  _has_bits_[0] |= 0x00000008u;
  yellow_cards_ = value;
}
inline void SSL_Referee_TeamInfo::set_yellow_cards(uint32_t value) {
...
inline uint32_t SSL_Referee_TeamInfo::_internal_timeouts() const {
  return timeouts_;
}
inline uint32_t SSL_Referee_TeamInfo::timeouts() const {
  // @@protoc_insertion_point(field_get:SSL_Referee.TeamInfo.timeouts)
  return _internal_timeouts();
}
inline void SSL_Referee_TeamInfo::_internal_set_timeouts(uint32_t value) {
  _has_bits_[0] |= 0x00000010u;
  timeouts_ = value;
}
inline void SSL_Referee_TeamInfo::set_timeouts(uint32_t value) {
...
inline uint32_t SSL_Referee_TeamInfo::_internal_timeout_time() const {
  return timeout_time_;
}
inline uint32_t SSL_Referee_TeamInfo::timeout_time() const {
  // @@protoc_insertion_point(field_get:SSL_Referee.TeamInfo.timeout_time)
  return _internal_timeout_time();
}
inline void SSL_Referee_TeamInfo::_internal_set_timeout_time(uint32_t value) {
  _has_bits_[0] |= 0x00000020u;
  timeout_time_ = value;
}
inline void SSL_Referee_TeamInfo::set_timeout_time(uint32_t value) {
...
inline uint32_t SSL_Referee_TeamInfo::_internal_goalie() const {
  return goalie_;
}
inline uint32_t SSL_Referee_TeamInfo::goalie() const {
  // @@protoc_insertion_point(field_get:SSL_Referee.TeamInfo.goalie)
  return _internal_goalie();
}
inline void SSL_Referee_TeamInfo::_internal_set_goalie(uint32_t value) {
  _has_bits_[0] |= 0x00000040u;
  goalie_ = value;
}
inline void SSL_Referee_TeamInfo::set_goalie(uint32_t value) {
...
inline uint64_t SSL_Referee::_internal_packet_timestamp() const {
  return packet_timestamp_;
}
inline uint64_t SSL_Referee::packet_timestamp() const {
  // @@protoc_insertion_point(field_get:SSL_Referee.packet_timestamp)
  return _internal_packet_timestamp();
}
inline void SSL_Referee::_internal_set_packet_timestamp(uint64_t value) {
  _has_bits_[0] |= 0x00000010u;
  packet_timestamp_ = value;
}
inline void SSL_Referee::set_packet_timestamp(uint64_t value) {
...
inline int32_t SSL_Referee::_internal_stage_time_left() const {
  return stage_time_left_;
}
inline int32_t SSL_Referee::stage_time_left() const {
  // @@protoc_insertion_point(field_get:SSL_Referee.stage_time_left)
  return _internal_stage_time_left();
}
inline void SSL_Referee::_internal_set_stage_time_left(int32_t value) {
  _has_bits_[0] |= 0x00000040u;
  stage_time_left_ = value;
}
inline void SSL_Referee::set_stage_time_left(int32_t value) {
...
inline uint32_t SSL_Referee::_internal_command_counter() const {
  return command_counter_;
}
inline uint32_t SSL_Referee::command_counter() const {
  // @@protoc_insertion_point(field_get:SSL_Referee.command_counter)
  return _internal_command_counter();
}
inline void SSL_Referee::_internal_set_command_counter(uint32_t value) {
  _has_bits_[0] |= 0x00000100u;
  command_counter_ = value;
}
inline void SSL_Referee::set_command_counter(uint32_t value) {
...
inline uint64_t SSL_Referee::_internal_command_timestamp() const {
  return command_timestamp_;
}
inline uint64_t SSL_Referee::command_timestamp() const {
  // @@protoc_insertion_point(field_get:SSL_Referee.command_timestamp)
  return _internal_command_timestamp();
}
inline void SSL_Referee::_internal_set_command_timestamp(uint64_t value) {
  _has_bits_[0] |= 0x00000200u;
  command_timestamp_ = value;
}
inline void SSL_Referee::set_command_timestamp(uint64_t value) {
